...
public class ClienteResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClienteNewDTO objDto) { // @valid para validar atraves da DTO
	...
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(name="file") MultipartFile file) { // @valid para validar atraves da DTO
